...
**IMPORTANT:** After any frontend change (client/src/**), always run `npm run build` before deploying or testing production builds. The Vite dev server hot-reloads, but the production bundle must be rebuilt manually.
